...
"""
peso = int(input("Digite o quantidade (Kg) de peixes: "))

excesso = peso - 50
multa = excesso * 4

print(f"""
Quantidade de peixe pescado: {peso} Kg
Quantidade de peixe me excesso: {excesso} Kg
Valor da Multa por excesso: {multa} R$
""")